...
engine: engine.c monitor_ioctl.h
	gcc -O2  -o engine engine.c -lpthread

memory_hog: memory_hog.c
	gcc -O2 $(WORKLOAD_LDFLAGS) -o memory_hog memory_hog.c

cpu_hog: cpu_hog.c
	gcc -O2 $(WORKLOAD_LDFLAGS) -o cpu_hog cpu_hog.c

io_pulse: io_pulse.c
	gcc -O2 $(WORKLOAD_LDFLAGS) -o io_pulse io_pulse.c
